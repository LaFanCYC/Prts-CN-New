(() => {
  ...
  if (!root) return;
  root.innerHTML = '<section class="ai-assistant-panel" aria-label="AI 搜索助手"><h2>AI 搜索助手</h2><p>描述你想找的资源、帖子或失物信息。</p><form class="ai-assistant-form"><input name="query" maxlength="100" placeholder="例如：想找 Python 教材" required><button class="btn btn-primary">搜索</button></form><div class="ai-result-list" aria-live="polite"></div></section><button class="ai-assistant-toggle" type="button" aria-label="打开 AI 搜索助手" aria-expanded="false">✦</button>';
